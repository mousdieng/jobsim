-- Migration: 005_add_admin_system_v2 (Corrected)
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_enum WHERE enumlabel = 'enterprise' AND enumtypid = 'user_type'::regtype) THEN
...
-- ============================================
-- 4. Extend enterprises table (already exists)
-- ============================================
...
-- ============================================
-- 5. Add admin fields to tasks table
-- ============================================
...
-- ============================================
-- 6. Add admin fields to task_submissions
-- ============================================
...
COMMENT ON TABLE admin_audit_logs IS 'Admin system successfully installed.
Next steps:
1. Create super admin: UPDATE users SET user_type = ''super_admin'', status = ''active'' WHERE email = ''your-admin@email.com'';
2. Access admin panel at /admin/dashboard
3. Review ADMIN_SETUP_GUIDE.md for complete documentation';
